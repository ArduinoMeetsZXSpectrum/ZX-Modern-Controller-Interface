...
XBoxOneUSBGamepad::XBoxOneUSBGamepad(USB *pUsb) : XBOXONE(pUsb), oldDpadState(0), oldButtonsState(0), listener(0)
{
...
XBoxOneUSBGamepad::~XBoxOneUSBGamepad()
{

}

uint8_t XBoxOneUSBGamepad::Poll()
{
	//Serial.println("XBoxOneUSBGamepad::poll");
	uint8_t status = XBOXONE::Poll();
...
void XBoxOneUSBGamepad::setListener(JoystickListener* listener)
{
